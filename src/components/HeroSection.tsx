...
const HeroSection = () => {
  ...
  return (
    <section className="pt-32 pb-16 px-4 overflow-hidden relative min-h-[90vh] flex items-center">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Badge variant="secondary" className="w-fit bg-cyber-dark text-cyber-cyan border-cyber-cyan/50 backdrop-blur-md shadow-[0_0_15px_rgba(0,240,255,0.3)] px-4 py-1 flex items-center gap-2 tracking-widest uppercase text-xs font-bold">
                <Terminal className="w-3 h-3" /> Immersive Learning Hub
              </Badge>
            </motion.div>

            <div className="space-y-4">
              <h1 className="text-5xl lg:text-7xl font-extrabold leading-tight tracking-tighter uppercase smooth-hover">
                Master Code <br />
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-lg font-mono">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/paths">
                <Button size="lg" className="gap-2 bg-cyber-cyan hover:bg-cyber-cyan/80 text-cyber-dark uppercase font-bold tracking-widest shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all hover:scale-105 rounded-sm">
                  <Play className="h-5 w-5" />
                  Start Coding
                </Button>
              </Link>
              <Link to="/progress">
                <Button size="lg" variant="outline" className="gap-2 border-cyber-pink text-cyber-pink hover:bg-cyber-pink hover:text-white uppercase font-bold tracking-widest shadow-[0_0_15px_rgba(255,0,60,0.2)] transition-all hover:scale-105 rounded-sm">
